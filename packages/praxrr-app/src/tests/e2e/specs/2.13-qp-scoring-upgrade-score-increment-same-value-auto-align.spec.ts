/**
 * 2.13 Quality Profile — scoring upgrade score increment desired already matches upstream
 *
 * Setup: Local changes upgrade score increment. Upstream sets same upgrade score increment.
