...
<div class="space-y-2">
  ...
  <div
    class="rounded-xl border border-neutral-200 bg-white p-2 px-3 font-mono text-sm break-all text-neutral-900 dark:border-neutral-700/70 dark:bg-neutral-900 dark:text-neutral-100"
  >
    {hasDisplayValue ? visibleValue || '••••••••' : noValueLabel}
  </div>
