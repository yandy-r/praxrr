...
<div class="space-y-3">
	...
	<div class="overflow-hidden rounded-xl border border-neutral-300 bg-neutral-50 dark:border-neutral-700/60 dark:bg-neutral-900/50">
		<div class="flex flex-wrap items-center justify-between gap-3 border-b border-neutral-200 bg-white px-4 py-2.5 dark:border-neutral-700/60 dark:bg-neutral-950/40">
			<div class="min-w-0">
