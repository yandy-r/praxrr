...
{#if open}
  ...
  >
    ...
    <div class="flex min-h-full w-full items-start justify-center sm:items-center" on:click|self={handleCancel}>
      <!-- Modal -->
      <div
      ...
      >
        ...
        <!-- Footer -->
        <div class="flex flex-shrink-0 justify-between border-t border-neutral-200 px-6 py-4 dark:border-neutral-800">
