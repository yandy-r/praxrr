...
>
  <div slot="body">
    <div class="space-y-4">
      <FormInput label="New Name" bind:value={newName} placeholder="Enter a name for the clone" required />

      {#if nameConflict}
        <p class="text-xs text-red-600 dark:text-red-400">An entity with this name already exists.</p>
      {/if}

      {#if canWriteToBase}
        <fieldset class="space-y-2">
          <legend class="block text-sm font-medium text-neutral-900 dark:text-neutral-100"> Layer </legend>
