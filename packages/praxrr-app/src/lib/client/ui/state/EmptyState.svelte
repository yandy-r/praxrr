...
<div class="flex min-h-[calc(100vh-4rem)] items-center justify-center p-8">
  <div class="w-full max-w-md text-center">
    ...
    <a
      href={buttonHref}
      class="bg-accent-600 hover:bg-accent-700 dark:bg-accent-500 dark:hover:bg-accent-600 inline-flex items-center gap-2 rounded-lg px-6 py-3 text-sm font-medium text-white transition-colors"
    >
