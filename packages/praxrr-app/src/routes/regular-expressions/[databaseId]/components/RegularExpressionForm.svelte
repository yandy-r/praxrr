<script lang="ts">
  ...
  $: description_ =
    mode === 'create' ? `Create a new regular expression for ${databaseName}` : `Update regular expression settings`;
...
<div class="space-y-6">
  ...
  >
    ...
    <!-- Keep description in the payload even when the advanced slot is collapsed -->
    ...
    <div class="space-y-6 pb-12">
      ...
      >
        ...
        <svelte:fragment slot="advanced">
          ...
          <!-- Description -->
          <div>
            <!-- name omitted: the hidden input above always carries this value -->
            <MarkdownInput
              id="description"
              label="Description"
