...
<div class="space-y-4 rounded-lg border border-neutral-200 bg-white p-4 dark:border-neutral-800 dark:bg-neutral-900">
  <div class="space-y-1">
    <h2 class="text-sm font-semibold text-neutral-900 dark:text-neutral-100">Single Release Score Simulation</h2>
  ...
  {#if !parserAvailable}
    ...
    >
      ...
      <p>Parser service unavailable. Score simulation requires parser output to evaluate release titles.</p>
    </div>
  {/if}
