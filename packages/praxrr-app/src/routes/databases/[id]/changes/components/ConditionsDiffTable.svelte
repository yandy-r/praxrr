<script lang="ts">
  ...
  function extractConditionValue(values?: Record<string, unknown> | null): { value: string; mono: boolean } | null {
  ...
  function formatChange(before?: string | number | boolean | null, after?: string | number | boolean | null): string {
