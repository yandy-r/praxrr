...
<div class="mt-6 space-y-6">
  {#if specifications.length === 0}
    ...
    >
      <p class="text-neutral-600 dark:text-neutral-400">No conditions defined for this custom format.</p>
    </div>
  {:else}
    <Table {columns} data={specifications} compact hoverable={false} emptyMessage="No conditions" responsive />
