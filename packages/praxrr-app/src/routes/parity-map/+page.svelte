...
<div class="space-y-8">
	<div>
		...
		<p class="mt-1 text-sm text-neutral-600 dark:text-neutral-400">
			Compare entity support and known semantic differences across Radarr, Sonarr, and Lidarr, then
			check which quality profiles in a linked database are usable by each app.
		</p>
	</div>
	...
	<section>
		<h2 class="mb-3 text-lg font-semibold text-neutral-900 dark:text-neutral-50">
