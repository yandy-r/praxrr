...
>
  <div class="space-y-6">
    ...
    <div>
      <label for="tmdb_stored_api_key" class="mb-2 block text-sm font-semibold text-neutral-900 dark:text-neutral-50">
        Stored API Read Access Token
      </label>
      {#key remaskSession}
        <MaskedApiKey
      ...
      <p class="mt-1 text-xs text-neutral-500 dark:text-neutral-400">
        ...
        <a
          ...
          class="text-accent-600 dark:text-accent-400 hover:underline">themoviedb.org</a
        >
      </p>
    </div>
    ...
    <div>
      <label for="tmdb_api_key" class="mb-2 block text-sm font-semibold text-neutral-900 dark:text-neutral-50">
        Update API Read Access Token
      </label>
      <div class="relative">
        <input
...
>
  <button type="submit" class="hidden" aria-label="Reveal TMDB API key" bind:this={revealSubmitButton}></button>
</form>
