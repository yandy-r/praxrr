<script lang="ts">
  ...
  let alertDurationSeconds: number | undefined = Math.round(DEFAULT_ALERT_SETTINGS.durationMs / 1000);
...
<div class="rounded-lg border border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-900">
  ...
  <div class="border-b border-neutral-200 px-6 py-4 dark:border-neutral-800">
    ...
    <p class="mt-1 text-sm text-neutral-600 dark:text-neutral-400">Customize the look and feel of the application</p>
  </div>
  ...
  <div class="p-6">
    <div class="space-y-6">
        ...
        <div class="space-y-2">
          <div class="flex items-center gap-3">
            ...
            <button type="button" class="flex-1 text-left" on:click={toggleNavIcons}>
              <span class="text-sm font-medium text-neutral-900 dark:text-neutral-50"> Use Emojis </span>
      ...
      <div class="space-y-3">
        ...
        <div class="space-y-4">
          <div>
            <label for="alert_position" class="mb-1 block text-sm font-medium text-neutral-900 dark:text-neutral-50">
              Position
            </label>
            <SearchDropdown
              name="alert_position"
          ...
          <div>
            <label for="alert_duration" class="mb-1 block text-sm font-medium text-neutral-900 dark:text-neutral-50">
              Duration (seconds)
            </label>
            <NumberInput
              name="alert_duration"
            ...
            />
            <p class="mt-1 text-xs text-neutral-500 dark:text-neutral-400">Set to 0 to keep alerts until dismissed.</p>
          </div>
        </div>
      </div>
    </div>
