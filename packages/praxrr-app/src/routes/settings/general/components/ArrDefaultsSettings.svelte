...
<div class="rounded-lg border border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-900">
  ...
  <div class="border-b border-neutral-200 px-6 py-4 dark:border-neutral-800">
    <h2 class="text-lg font-semibold text-neutral-900 md:text-xl dark:text-neutral-50">Arr Instance Defaults</h2>
        ...
        <div class="space-y-2">
          <div class="flex items-center gap-3">
            <IconCheckbox
              ...
              on:click={() => (settings.apply_default_delay_profiles = !settings.apply_default_delay_profiles)}
            />
            <input
              type="hidden"
