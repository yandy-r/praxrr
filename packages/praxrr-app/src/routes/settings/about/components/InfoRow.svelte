  ...
  <td class="px-6 py-4 text-sm">
    ...
    {:else if type === 'link' && href}
      <a
        ...
        class="text-accent-600 hover:text-accent-700 dark:text-accent-400 dark:hover:text-accent-300 rounded bg-neutral-100 px-2 py-1 font-mono dark:bg-neutral-800"
      >
        {value}
      </a>
    {:else}
