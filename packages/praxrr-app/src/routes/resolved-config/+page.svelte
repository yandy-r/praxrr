<script lang="ts">
  ...
  const storageKey = 'resolvedConfigDatabase';
...
{#if data.databases.length === 0}
  <EmptyState
    ...
    description="Link a Praxrr Compliant Database to inspect its resolved configuration."
