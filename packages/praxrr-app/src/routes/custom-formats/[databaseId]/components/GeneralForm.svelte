<script lang="ts">
  ...
  $: description_ =
    mode === 'create' ? `After saving, you'll be able to add conditions and tests.` : `Update custom format settings`;
  ...
  <div class="space-y-6">
    ...
    >
      ...
      <div class="space-y-6">
        ...
        <!-- Include In Rename -->
        <div class="space-y-2">
          <div class="block text-sm font-medium text-neutral-900 dark:text-neutral-100">Include In Rename</div>
          <p class="text-xs text-neutral-600 dark:text-neutral-400">
