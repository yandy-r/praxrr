<script lang="ts">
  ...
  $: pageDescription = mode === 'create' ? `Add a test case for ${formatName}` : `Update test case settings`;
  ...
  >
    ...
    <div class="rounded-lg border border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-900">
      <div class="space-y-6 p-4">
        ...
        <!-- Media Type -->
        <div>
          <div class="mb-3 block text-sm font-medium text-neutral-700 dark:text-neutral-300">Media Type</div>
        ...
        <!-- Expected Result -->
        <div>
          <div class="mb-3 block text-sm font-medium text-neutral-700 dark:text-neutral-300">Expected Result</div>
          <div class="grid gap-2 sm:grid-cols-2">
