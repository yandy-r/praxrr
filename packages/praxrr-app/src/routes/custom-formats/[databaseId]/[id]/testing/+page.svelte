  ...
  <StickyCard position="top">
    <svelte:fragment slot="left">
      <div>
        ...
        <p class="text-sm text-neutral-600 dark:text-neutral-400">Test release titles against this custom format</p>
      </div>
    </svelte:fragment>
  ...
  <div class="mt-6 space-y-6 pb-12 md:px-4">
    ...
    {#if !data.parserAvailable}
      ...
      >
        ...
        <div>
          <p class="text-sm font-medium text-amber-800 dark:text-amber-200">Parser service unavailable</p>
    ...
    {:else}
      ...
      >
        ...
        <svelte:fragment slot="expanded" let:row>
          ...
          {@const optionalPass = optionalConditions.length === 0 || optionalConditions.some((c: Condition) => c.passes)}
                        ...
                        <tr>
                          ...
                          {#if condIndex === 0}
                            {@const requiredPass = conditions
                              .filter((c: Condition) => c.required)
                              .every((c: Condition) => c.passes)}
                            {@const optionalConditions = conditions.filter((c: Condition) => !c.required)}
                            {@const optionalPass =
                          ...
                          {#if typeIndex === 0 && condIndex === 0}
                            ...
                            >
                              {#if row.should_match}
                                ...
                                <div class="mt-1 text-[10px] font-medium text-emerald-600 dark:text-emerald-400">
                                  MATCH
                                </div>
                              {:else}
                                <div
                            ...
                            >
                              ...
                              {:else}
                                ...
                                <div class="mt-1 text-[10px] font-medium text-amber-600 dark:text-amber-400">
                                  UNKNOWN
                                </div>
                              {/if}
                            </td>
                  ...
                  <div class="mt-2 flex flex-wrap gap-2">
                    ...
                    <div class="flex items-center gap-1.5">
                      ...
                      <Badge variant="neutral" size="md"
                        >{row.parsed.languages.length > 0 ? row.parsed.languages.join(', ') : 'None'}</Badge
                      >
                    </div>
