    ...
    {#each arrTypeOptions as option}
      ...
      >
        <div class="flex h-12 w-12 items-center justify-center">
          ...
          {:else}
            <span
              class="flex h-10 w-10 items-center justify-center rounded-lg border border-neutral-300 bg-neutral-100 text-sm font-semibold text-neutral-700 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-200"
            >
              {option.label[0]}
            </span>
          {/if}
