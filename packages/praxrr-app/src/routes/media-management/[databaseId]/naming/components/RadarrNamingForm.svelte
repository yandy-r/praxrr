  ...
  <div class="space-y-6 rounded-lg border border-neutral-200 bg-white p-6 dark:border-neutral-800 dark:bg-neutral-900">
    ...
    <div class="space-y-4">
      ...
      <div class="space-y-2">
        ...
        />
        <p class="text-xs text-neutral-500 dark:text-neutral-400">Rename movie files to match the naming format</p>
      </div>
    </div>
  ...
  <div class="space-y-4 text-sm text-neutral-600 dark:text-neutral-400">
    ...
    <div>
      ...
      <p class="mt-1">
        ...
        how colons specifically are handled (deleted, replaced with a dash, space, etc.).
      </p>
    </div>
  </div>
</InfoModal>
