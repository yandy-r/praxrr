<script lang="ts">
  ...
  $: description =
    mode === 'create' ? `Create a new delay profile for ${databaseName}` : `Update delay profile settings`;
  ...
  >
    ...
    >
      <div class="space-y-6">
        ...
        <!-- Protocol Preference -->
        <div>
          <h3 class="text-sm font-semibold text-neutral-900 dark:text-neutral-100">Protocol Preference</h3>
