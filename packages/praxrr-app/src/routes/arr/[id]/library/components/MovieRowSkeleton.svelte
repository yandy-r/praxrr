...
{#if column.key === 'title'}
  <div class="space-y-1.5">
    <div class="h-4 {randomWidth()} animate-pulse rounded bg-neutral-200 dark:bg-neutral-700"></div>
    <div class="h-3 w-12 animate-pulse rounded bg-neutral-100 dark:bg-neutral-800"></div>
  </div>
...
{:else if column.key === 'qualityName'}
  <div class="h-6 w-16 animate-pulse rounded bg-neutral-100 dark:bg-neutral-800"></div>
{:else if column.key === 'customFormatScore'}
  <div class="flex justify-end gap-1">
    <div class="h-4 w-10 animate-pulse rounded bg-neutral-200 dark:bg-neutral-700"></div>
...
{:else if column.key === 'actions'}
  <div class="flex justify-center">
    <div class="h-7 w-7 animate-pulse rounded border border-neutral-200 dark:border-neutral-700"></div>
  </div>
{/if}
