...
<InfoModal bind:open header="How Rename Works">
  <div class="space-y-6">
    <!-- Overview -->
    <div>
      <h3 class="mb-2 font-semibold text-neutral-900 dark:text-neutral-100">Overview</h3>
      <p class="text-sm text-neutral-600 dark:text-neutral-400">
        The rename feature scans your library and renames files that don't match your Radarr/Sonarr naming format. This
        helps keep your library organized and consistent without manual intervention.
      </p>
    </div>
    ...
    <div>
      ...
      <dl class="space-y-3 text-sm">
        ...
        <div>
          ...
          <dd class="text-neutral-600 dark:text-neutral-400">
            When enabled, sends a compact notification with the total count and one sample rename. When disabled, sends
            detailed notifications listing every renamed file.
          </dd>
        </div>
      </dl>
    </div>
