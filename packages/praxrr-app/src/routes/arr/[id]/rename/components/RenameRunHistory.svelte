    ...
    <svelte:fragment slot="expanded" let:row>
      <div class="space-y-3 p-6">
        ...
        {#if row.filtering.skippedByTag > 0}
          <div class="flex">
            <span class="w-24 shrink-0 text-sm font-medium text-neutral-500 dark:text-neutral-400">Filtered</span>
            <span class="text-sm text-neutral-900 dark:text-neutral-100">
        ...
        <div class="flex">
          ...
          <span class="text-sm text-neutral-900 dark:text-neutral-100">
            ...
            {#if row.results.commandsFailed > 0}
              <span class="font-mono text-red-600 dark:text-red-400">, {row.results.commandsFailed} failed</span>
            {/if}
          </span>
        </div>
                  ...
                  {#each item.files as file}
                    <div class="space-y-1">
                      <div class="flex gap-2">
                        <span class="w-12 shrink-0 text-xs font-medium text-neutral-500 dark:text-neutral-400"
                          >From:</span
                        >
                      ...
                      <div class="flex gap-2">
                        <span class="w-12 shrink-0 text-xs font-medium text-emerald-600 dark:text-emerald-400">To:</span
                        >
                        <span class="font-mono text-xs break-all text-neutral-700 dark:text-neutral-300">
