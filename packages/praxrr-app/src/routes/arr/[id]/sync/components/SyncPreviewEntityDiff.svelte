<script lang="ts">
	...
	$: summaryText =
		entity.fields.length === 1
			? '1 field change'
			: `${entity.fields.length} field changes`;
			...
			{:else}
				<div class="overflow-x-auto">
					<table class="w-full text-left text-sm">
						<thead>
							<tr class="border-b border-neutral-200 text-xs text-neutral-500 dark:border-neutral-700 dark:text-neutral-400">
							...
							{#each entity.fields as fieldChange}
								...
								<tr class="border-b border-neutral-100 dark:border-neutral-800">
									...
									<td class="py-2 align-top">
										<span class={`inline-flex rounded-full px-2 py-0.5 text-xs font-semibold ${fieldMeta.textClass}`}>{fieldMeta.label}</span>
									</td>
									<td class="py-2 align-top">
										<pre class="max-w-xs overflow-x-auto rounded border border-neutral-200 bg-neutral-50 p-2 text-xs text-neutral-700 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-200">
