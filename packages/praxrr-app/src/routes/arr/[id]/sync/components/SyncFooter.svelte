<script lang="ts">
  ...
  export let canSync: boolean = true;
  ...
  $: syncDisabled = syncing || isDirty || !canSync;
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
      ...
      <div class="flex items-center gap-3">
        ...
        <Button
          ...
          iconColor={syncing ? 'text-blue-600 dark:text-blue-400 animate-spin' : 'text-blue-600 dark:text-blue-400'}
        ...
        <Button
          ...
          iconColor={saving ? 'text-green-600 dark:text-green-400 animate-spin' : 'text-green-600 dark:text-green-400'}
