<script lang="ts">
  ...
  $: selectedKey =
    state.databaseId !== null && state.profileName !== null ? `${state.databaseId}-${state.profileName}` : null;
...
<div class="rounded-lg border border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-900">
  ...
  <div class="border-b border-neutral-200 px-6 py-4 dark:border-neutral-800">
    ...
    <p class="mt-1 text-sm text-neutral-600 dark:text-neutral-400">Select delay profiles to sync to this instance</p>
  </div>
