<script lang="ts">
  import { Plus, Pencil, Check, Power, Copy, ClipboardCopy, ClipboardPaste, Trash2 } from 'lucide-svelte';
          ...
          <div class="flex items-center">
            {#if editingId === row.id}
              ...
              <input
                ...
                on:blur={() => saveEditing()}
                class="focus:border-accent-500 w-40 rounded border border-neutral-300 bg-white px-2 py-1 text-sm font-medium text-neutral-900 focus:outline-none dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-100"
                autofocus
              />
            {:else}
              <span
      ...
      <div class="space-y-4 p-6">
        ...
        >
          ...
          <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
            <div>
              <label for="cutoff-{row.id}" class="block text-sm font-medium text-neutral-600 dark:text-neutral-400">
                Cutoff %
              </label>
              <div class="mt-1">
                <NumberInput
              ...
              <p class="mt-1 text-xs text-neutral-500 dark:text-neutral-400">Score threshold for "cutoff met"</p>
            </div>
            <div>
              <label
                for="selector-{row.id}"
            ...
            <div>
              <label for="count-{row.id}" class="block text-sm font-medium text-neutral-600 dark:text-neutral-400">
                Count
              </label>
              <div class="mt-1">
                <NumberInput
              ...
              <p class="mt-1 text-xs text-neutral-500 dark:text-neutral-400">Items to select per run</p>
            </div>
          </div>
        </div>
      </div>
