...
<StickyCard position="top">
  <div slot="left">
    ...
    <p class="text-sm text-neutral-500 dark:text-neutral-400">Automatically search for better quality releases.</p>
  </div>
...
<div class="mt-6 space-y-6">
  ...
  <section>
    <CollapsibleCard title="Filters" sectionKey={ARR_UPGRADES_FILTER} defaultOpen={true}>
      <FilterSettings {filters} onFiltersChange={(v) => update('filters', JSON.stringify(v))} />
    </CollapsibleCard>
  </section>
</div>
