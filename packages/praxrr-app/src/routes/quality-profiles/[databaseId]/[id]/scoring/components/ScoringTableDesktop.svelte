...
<div use:action class="overflow-x-auto rounded-lg border border-neutral-200 dark:border-neutral-800">
  <table class="w-full">
    ...
    <tbody class="divide-y divide-neutral-200 bg-white dark:divide-neutral-800 dark:bg-neutral-900">
      ...
      {:else}
        ...
        {#each visibleFormats as format (format.name)}
          {@const rowDisabled = arrTypes.every((arrType) => !customFormatEnabled[format.name]?.[arrType])}
          <tr
