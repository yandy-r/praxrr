/**
 * 2.10 Quality Profile — local delete vs upstream rename
 *
...
test.describe('2.10 QP local delete vs upstream rename', () => {
  ...
  test.beforeEach(async ({ browser }) => {
    ...
    renamedProfileName = `${profileName} Dev Rename 2.10 ${Date.now()}`;
    await page.close();
  });
