...
<div class="mt-2 flex items-center gap-2.5 rounded-lg border border-neutral-300 px-3 py-2 dark:border-neutral-700">
  <img src={logo} alt="Praxrr logo" class="h-5 w-5 flex-shrink-0" />

  <div class="flex-1">
    <div class="text-xs font-semibold text-neutral-900 dark:text-neutral-50">praxrr</div>
