...
const aliases: Record<string, string> = {
  ...
  'security-posture':
    'packages/praxrr-app/src/tests/shared/security,packages/praxrr-app/src/tests/shared/scoring/rollup.test.ts,packages/praxrr-app/src/tests/routes/securityPosture.test.ts,packages/praxrr-app/src/tests/logger/sanitizerRegression.test.ts,packages/praxrr-app/src/tests/server/security,packages/praxrr-app/src/tests/server/utils/auth,packages/praxrr-app/src/tests/server/utils/config',
