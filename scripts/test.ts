...
const aliases: Record<string, string> = {
  ...
  plugins:
    'packages/praxrr-app/src/tests/shared/plugins,packages/praxrr-app/src/tests/plugins,packages/praxrr-app/src/tests/db/pluginRegistryQueries.test.ts,packages/praxrr-app/src/tests/routes/plugins.test.ts,packages/praxrr-app/src/tests/routes/pluginManagementPresentation.test.ts,packages/praxrr-app/src/tests/mcp/mcp.test.ts',
  resolvedConfig:
