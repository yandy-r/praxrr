...
const aliases: Record<string, string> = {
  ...
  'config-health':
    'packages/praxrr-app/src/tests/shared/health,packages/praxrr-app/src/tests/health,packages/praxrr-app/src/tests/db/configHealthSnapshots.test.ts,packages/praxrr-app/src/tests/db/configHealthSettings.test.ts,packages/praxrr-app/src/tests/routes/configHealth.test.ts,packages/praxrr-app/src/tests/jobs/configHealthSnapshot.test.ts,packages/praxrr-app/src/tests/jobs/configHealthCleanup.test.ts,packages/praxrr-app/src/tests/db/configHealthNotificationState.test.ts,packages/praxrr-app/src/tests/server/health/gatherTrashRecommended.test.ts',
  complexity:
  ...
  mcp: 'packages/praxrr-app/src/tests/mcp',
  normalize: 'packages/praxrr-app/src/tests/upgrades/normalize.test.ts',
  notifications:
    'packages/praxrr-app/src/tests/notifications/manager.test.ts,packages/praxrr-app/src/tests/shared/health/degradation.test.ts,packages/praxrr-app/src/tests/jobs/configHealthSnapshot.test.ts',
  parity:
  ...
  plugins:
    'packages/praxrr-app/src/tests/shared/plugins,packages/praxrr-app/src/tests/plugins,packages/praxrr-app/src/tests/db/pluginRegistryQueries.test.ts,packages/praxrr-app/src/tests/routes/plugins.test.ts,packages/praxrr-app/src/tests/routes/pluginManagementContract.test.ts,packages/praxrr-app/src/tests/routes/pluginManagementPresentation.test.ts,packages/praxrr-app/src/tests/mcp/mcp.test.ts',
  resolvedConfig:
    'packages/praxrr-app/src/tests/pcd/resolved,packages/praxrr-app/src/tests/routes/resolvedConfigApi.test.ts',
  'security-posture':
    'packages/praxrr-app/src/tests/shared/security,packages/praxrr-app/src/tests/shared/scoring/rollup.test.ts,packages/praxrr-app/src/tests/routes/securityPosture.test.ts,packages/praxrr-app/src/tests/logger/sanitizerRegression.test.ts,packages/praxrr-app/src/tests/base/trustedProxyConfig.test.ts,packages/praxrr-app/src/tests/base/networkTrust.test.ts,packages/praxrr-app/src/tests/server/security,packages/praxrr-app/src/tests/server/utils/auth,packages/praxrr-app/src/tests/server/utils/config,packages/praxrr-app/src/tests/server/utils/http',
