---
title: lidarr_metadata_profile_secondary_types
description: Secondary type allowances for Lidarr metadata profiles.
---

## Purpose

Stores secondary metadata type rows for each Lidarr metadata profile. The `allowed` flag controls whether the type is permitted.
