---
title: sonarr_media_settings
description: Sonarr general media settings.
---

## Purpose

Sonarr general media settings including propers/repacks preference and media info probing.
...
- **Arr-type note:** Sonarr-only sibling of `radarr_media_settings`.
