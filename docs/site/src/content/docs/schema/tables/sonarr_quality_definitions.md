---
title: sonarr_quality_definitions
description: Sonarr quality size definitions.
---

## Purpose

Sonarr-specific quality size limits keyed by configuration `name` and canonical `quality_name`. Used when syncing quality definitions to Sonarr instances.
