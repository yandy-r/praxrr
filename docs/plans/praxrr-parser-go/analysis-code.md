...
- `/packages/praxrr-app/src/lib/server/utils/arr/parser/client.ts:6`: Central HTTP client and cache orchestration entry point.
- `/packages/praxrr-app/src/lib/server/utils/parser/spawn.ts:1`: Auto-spawn, health wait, and env wiring for parser process.
- `/packages/praxrr-app/src/lib/server/db/queries/parsedReleaseCache.ts:1`: Parse cache keyed by parser version.
- `/packages/praxrr-app/src/lib/server/db/queries/patternMatchCache.ts:1`: Pattern match cache keyed by title/pattern hash.
- `/packages/praxrr-parser/Endpoints/MatchEndpoints.cs:16`: Existing fail-closed match behavior and timeout semantics.
...
- Example: `/packages/praxrr-app/src/lib/server/utils/arr/parser/client.ts:75`
...
- Example: `/packages/praxrr-app/src/lib/server/utils/arr/parser/client.ts:225`
...
- Example: `/packages/praxrr-app/src/lib/server/utils/arr/parser/client.ts:357`
...
- Example: `/packages/praxrr-parser/Endpoints/MatchEndpoints.cs:16`
...
- Example: `/packages/praxrr-app/src/lib/server/utils/parser/spawn.ts:1`
...
- `/packages/praxrr-parser-go/main.go`: Go service entrypoint and app bootstrap.
- `/packages/praxrr-parser-go/server/handlers.go`: Endpoint handlers for `/parse`, `/match`, `/match/batch`, `/health`.
- `/packages/praxrr-parser-go/parser/parser.go`: Top-level parser orchestration.
- `/packages/praxrr-parser-go/parser/common.go`: Shared parser utilities and regex helpers.
- `/packages/praxrr-parser-go/models/models.go`: Request/response DTOs and enum serialization.

#### Files to Modify

- `/packages/praxrr-app/src/lib/server/utils/parser/spawn.ts`: Ensure binary resolution and process invocation remain correct for Go artifact.
