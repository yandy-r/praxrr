...
The work replaces `src/services/parser` (.NET) with a Go parser service while preserving the exact HTTP and JSON contract consumed by existing TypeScript callers. The safest approach is parity-first: build fixture-driven regression coverage from current parser outputs, then port parser modules in independent slices using `regexp2`, and only then cut over runtime/build pipelines. Integration must preserve cache semantics (`parser_version`, pattern hash) and standalone spawn assumptions (`praxrr-parser` binary plus `/health`). The plan therefore separates foundation, parser implementation, and cutover so high-risk compatibility concerns are validated before deployment changes.

## Critically Relevant Files and Documentation

- /src/lib/server/utils/arr/parser/client.ts: Parser HTTP contract and cache orchestration behavior.
- /src/lib/server/utils/arr/parser/index.ts: Shared parser helper exports used across server routes.
- /src/lib/server/utils/parser/spawn.ts: Parser process discovery, startup, and health readiness.
- /src/lib/server/db/queries/parsedReleaseCache.ts: Version-keyed parse cache behavior.
- /src/lib/server/db/queries/patternMatchCache.ts: Pattern hash cache behavior for batch matching.
- /src/services/parser/Program.cs: Existing parser bootstrap and endpoint registration baseline.
- /src/services/parser/Endpoints/ParseEndpoints.cs: Existing `/parse` request/response semantics.
- /src/services/parser/Endpoints/MatchEndpoints.cs: Existing `/match` and `/match/batch` fail-closed semantics.
- /src/services/parser/Endpoints/HealthEndpoints.cs: Existing health response contract.
...
- /src/services/parser-go/testdata/fixtures.json
- /src/services/parser-go/testdata/golden-parse.json
- /src/services/parser-go/testdata/golden-match.json
...
- /src/services/parser-go/go.mod
- /src/services/parser-go/main.go
- /src/services/parser-go/models/models.go
...
- /src/services/parser-go/internal/testutil/golden.go
- /src/services/parser-go/parser/parity_test.go
...
- /src/services/parser/Parsers/ParserCommon.cs
- /src/services/parser/Parsers/Common/ParserCommon.cs
- /src/services/parser/Models/Types.cs
- /docs/plans/praxrr-parser-go/research-technical.md
...
- /src/services/parser-go/parser/common.go
- /src/services/parser-go/parser/types.go
...
- /src/services/parser/Parsers/QualityParser.cs
- /src/services/parser-go/parser/common.go
- /src/services/parser-go/parser/parity_test.go
...
- /src/services/parser-go/parser/quality.go
- /src/services/parser-go/parser/quality_test.go
...
- /src/services/parser/Parsers/LanguageParser.cs
- /src/services/parser/Parsers/ReleaseGroupParser.cs
- /src/services/parser-go/parser/parity_test.go
...
- /src/services/parser-go/parser/language.go
- /src/services/parser-go/parser/releasegroup.go
...
- /src/services/parser/Parsers/TitleParser.cs
- /src/services/parser-go/parser/common.go
- /src/services/parser-go/parser/parity_test.go
...
- /src/services/parser-go/parser/title.go
- /src/services/parser-go/parser/title_test.go
...
- /src/services/parser/Parsers/EpisodeParser.cs
- /src/services/parser-go/parser/common.go
- /src/services/parser-go/parser/parity_test.go
...
- /src/services/parser-go/parser/episode.go
- /src/services/parser-go/parser/episode_test.go
...
- /src/services/parser-go/parser/parser.go
- /src/services/parser-go/parser/match.go
...
- /src/services/parser/Program.cs
...
- /src/services/parser-go/server/handlers.go
- /src/services/parser-go/server/router.go
...
- /src/lib/server/utils/parser/spawn.ts
...
- /src/lib/server/utils/arr/parser/goParityNotes.md
...
- /src/services/parser-go/Dockerfile
...
- /src/services/parser-go/README.md
