...
- Keep pull processor arr-type agnostic; handle Radarr specifics in mapping/transform branches.
...
- Radarr-specific field mapping verification (`language`, `quality_modifier`)
...
- Radarr mapping regressions: add fixture-based round-trip tests for key resource classes.
...
1. Retitled and reshaped to match Sonarr second-pass recommendations format.
2. Removed architecture-heavy sections from recommendations-level output.
3. Replaced risk matrices with concise mitigation actions.
4. Kept scope focused on agreed pull categories and deferred expansion.
