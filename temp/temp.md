## Templates for Random Things - Linux
...
- only relative directory links to files
  - such as
    [@docs/plans/{feature-name}/parallel-plan.md](file:///home/yandy/Projects/github.com/yandy-r/docs/plans/{feature-name}/parallel-plan.md)
...
- only relative directory links to files
  - such as
    [@docs/plans/{feature-name}/parallel-plan.md](file:///Users/yandy/Projects/github.com/yandy-r/docs/plans/{feature-name}/parallel-plan.md)
